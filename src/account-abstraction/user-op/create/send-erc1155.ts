...
import {
  ...
  EstimateSendERC1155Options,
} from '../../interfaces';

export class XellarAACreateSendERC1155 extends XellarEWBase {
  /**
   * Create a user operation for sending ERC1155 tokens
   ...
   *
   * ```typescript
   * const result = await sdk.accountAbstraction.create.sendERC1155({
   ...
   * ```
   *
   * @see {@link https://docs.xellar.co/accountabstraction/api_reference/user_operation/hash/transfer_erc1155/ Xellar Account Abstraction Create Send ERC1155 Docs}
   */
  async sendERC1155(
